...
impl Location {
    ...
    pub fn next(self) -> Location {
        match self {
            ...
            Location::IceGoing => Location::Map,
            Location::IceToMeetYou => Location::IceGoing,
    ...
    pub fn prereqs(self) -> Vec<Location> {
        match self {
            ...
            Location::ColumnAsIcyEm => vec![Location::PointOfOrder],
            ...
            Location::IceGoing => vec![Location::IceToMeetYou],
            Location::IceToMeetYou => vec![Location::TreadLightly],
            ...
            Location::PointOfOrder => vec![Location::WhatchaColumn],
