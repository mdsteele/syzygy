...
impl SimpleState {
    fn initial_grid() -> PlaneGrid {
        ...
        grid.place_object(2, 4, PlaneObj::Node);
        grid.remove_object(4, 4);
        grid.remove_object(5, 4);
        grid.place_object(5, 5, PlaneObj::Node);
    ...
    fn advance_stage(&mut self) {
        ...
        match self.stage {
            3 => {
                self.grid.place_object(6, 3, PlaneObj::Node);
            ...
            4 => {
                ...
                self.grid.place_object(4, 3, PlaneObj::Node);
            ...
            5 => {
                ...
                self.grid.place_object(7, 5, PlaneObj::Node);
